...
class SaveManager{
    ...
    public static func readairlinecompany()->[String]{
        let saveData = UserDefaults.standard
        guard let object = saveData.object(forKey:"airlinecompany")as?[String] else {//EDIT
            return []//EDIT
        }//EDIT
        return object
    }
    public static func readmodel()->[String]{
        let saveData = UserDefaults.standard
        guard let object = saveData.object(forKey:"model")as?[String] else { //EDIT
            return []//EDIT
        }//EDIT
        return object
    }
    public static func readlocation()->[String]{
        let saveData = UserDefaults.standard
        guard let object = saveData.object(forKey:"location")as?[String] else {//EDIT
            return []//EDIT
        }//EDIT
        return object
    }
    public static func readshotdate()->[String]{
        let saveData = UserDefaults.standard
        guard let object = saveData.object(forKey:"shotingdate")as?[String] else {//EDIT
            return []//EDIT
        }//EDIT
        return object
    }
    public static func readaircraftnumber()->[String]{
        let saveData = UserDefaults.standard
        guard let object = saveData.object(forKey:"aircraftnumber")as?[String] else {//EDIT
            return []//EDIT
        }//EDIT
        return object
    }
